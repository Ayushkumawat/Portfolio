  ...
  return (
    <div className="about-content">
      ...
      <div className='cont'>
        ...
        <a href="https://github.com/Ayushkumawat/Portfolio/files/12290625/Ayush.Kumawat.s.Resume.pdf" className="btn" download="Ayush Kumawat's.pdf"><i><TfiSave/></i>Resume</a>
    </div>
